...
// ============================================
// UPDATED: populateFilterDropdowns - uses locations
// ============================================
...
// ============================================
// UPDATED: getFilteredMembers - uses location
// ============================================
...
// ============================================
// UPDATED: renderFilteredMembers - includes location
// ============================================
...
// ============================================
// UPDATED: exportFilteredData - includes location
// ============================================
...
// ============================================
// refreshPendingUsers - Load pending users
// ============================================
...
// ============================================
// renderPendingUsers - Render pending users list
// ============================================
...
function renderPendingUsers(pending) {
    ...
    pendingKeys.forEach(uid => {
        ...
        // SECURITY: Skip if this is the Super Admin (should never be in pending anyway)
...
async function approveUser(uid) {
    ...
    try {
        ...
        // SECURITY: NEVER allow assigning Super Admin
        if (role === 'super_admin') {
        ...
        // ============================================================
        // FIXED: Do NOT add to /admins/ - only Super Admin is there
        // Admins are identified by role: "admin" in /users/
        // ============================================================
        
        await db.ref('pendingUsers/' + uid).remove();
        
        // Also remove any other pending entries with same email
...
async function rejectUser(uid) {
    ...
    try {
        ...
        await db.ref('pendingUsers/' + uid).remove();
        // ============================================================
        // FIXED: Do NOT remove from /admins/ - only Super Admin is there
        // ============================================================
...
// ============================================
// fixUnapprovedUsers - Fix unapproved users
// ============================================
...
// ============================================
// viewAllUsers - View all users (hides ONLY Super Admin)
// ============================================
...
async function viewAllUsers() {
    try {
        ...
        const isSuperAdmin = window.isSuperAdmin === true || 
                             ...
                             (currentUser && currentUser.uid === SUPER_ADMIN_UID);
        ...
        Object.keys(users).forEach(uid => {
            ...
            // FIXED: Check role from /users/ not /admins/
...
async function changeUserRole(uid) {
    ...
    // ============================================================
    // SECURITY: NEVER allow changing to Super Admin
    // ============================================================
    ...
    try {
        ...
        // ============================================================
        // FIXED: Do NOT add/remove from /admins/
        // Only Super Admin is in /admins/
        // ============================================================
...
async function forceApproveUser(uid, role = 'admin') {
    try {
        // ============================================================
        // SECURITY: NEVER allow Super Admin
        // ============================================================
        if (role === 'super_admin') {
            showNotification('❌ Cannot assign Super Admin role', 'error');
            return;
